                      ...
                      Column(
                        children: recommended.map((acc) {
                          ...
                          bool hasPhalaAirdrop = store.staking
                              ...
                              false;
                          return Validator(acc, accInfo, store.settings.networkState.tokenDecimals,
        ...
        return RefreshIndicator(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int i) {
              ...
              return Validator(acc, accInfo, store.settings.networkState.tokenDecimals, hasPhalaAirdrop: hasPhalaAirdrop);
            },
          ),
        );
      },
